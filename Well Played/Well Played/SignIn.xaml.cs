...
namespace Well_Played
{
    ...
    public sealed partial class SignIn : Page
    {
        ...
        private async void AppBarButton_Accept(object sender, RoutedEventArgs e)
        {
            ...
            {                                              
                if (SummonerName.Text != "")
                {
                    try
                    {
                        Well_Played.Models.Summoner mySummonerData = await Facades.LeagueFacade.GetSummonerData(SummonerName.Text, (string)localSettings.Values["SummonerRegion"]);

                        if (mySummonerData.name != "ThisIsNotTheSummonerYoureLookingFor" && mySummonerData.name.Count() >= 4)
                        {
                            localSettings.Values["SummonerName"] = mySummonerData.name;
                            localSettings.Values["SummonerID"] = mySummonerData.id.ToString();
                            localSettings.Values["SummonerIconID"] = mySummonerData.profileIconId;
        ...
        {
            localSettings.Values["SummonerRegion"] = "br";
        ...
        {
            localSettings.Values["SummonerRegion"] = "eune";
        ...
        {
            localSettings.Values["SummonerRegion"] = "euw";
            BR_Rect.Fill.Opacity = 0;
            EUNE_Rect.Fill.Opacity = 0;
        ...
        {
            localSettings.Values["SummonerRegion"] = "kr";
            BR_Rect.Fill.Opacity = 0;
            EUNE_Rect.Fill.Opacity = 0;
            EUW_Rect.Fill.Opacity = 0;
        ...
        {
            localSettings.Values["SummonerRegion"] = "lan";
            BR_Rect.Fill.Opacity = 0;
            EUNE_Rect.Fill.Opacity = 0;
            EUW_Rect.Fill.Opacity = 0;
            KR_Rect.Fill.Opacity = 0;
        ...
        {
            localSettings.Values["SummonerRegion"] = "las";
            BR_Rect.Fill.Opacity = 0;
            EUNE_Rect.Fill.Opacity = 0;
            EUW_Rect.Fill.Opacity = 0;
            KR_Rect.Fill.Opacity = 0;
        ...
        {
            localSettings.Values["SummonerRegion"] = "oce";
            BR_Rect.Fill.Opacity = 0;
            EUNE_Rect.Fill.Opacity = 0;
            EUW_Rect.Fill.Opacity = 0;
            KR_Rect.Fill.Opacity = 0;
        ...
        {
            localSettings.Values["SummonerRegion"] = "ru";
            BR_Rect.Fill.Opacity = 0;
            EUNE_Rect.Fill.Opacity = 0;
            EUW_Rect.Fill.Opacity = 0;
            KR_Rect.Fill.Opacity = 0;
        ...
        {
            localSettings.Values["SummonerRegion"] = "tr";
            BR_Rect.Fill.Opacity = 0;
            EUNE_Rect.Fill.Opacity = 0;
            EUW_Rect.Fill.Opacity = 0;
            KR_Rect.Fill.Opacity = 0;
        ...
        {
            switch (localSettings.Values["SummonerRegion"].ToString())
            {
                case "br":
                    BR_Rect.Fill.Opacity = .5;
                    EUNE_Rect.Fill.Opacity = 0;
