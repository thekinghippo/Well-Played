...
namespace Well_Played
{
    ...
    /// </summary>
    public sealed partial class SummonerLookUp : Page
    {
        ...
        private async void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (SummonerMatches.Count == 0 || diditwork == false)
            {
                try
                {
                    ...
                    Models.MatchList ListOfMatches = await MatchFacade.GetMatchList((string)localSettings.Values["LookUpID"]);
                    await Facades.LeagueFacade.GetSummonerMostPlayedChamps(MostPlayedChampions, (string)localSettings.Values["LookUpID"], (string)localSettings.Values["LookUpRegion"], Version);
                    ...
                    RankedStats TotalStats = await Facades.LeagueFacade.GetRankedStatTotals((string)localSettings.Values["LookUpID"], (string)localSettings.Values["LookUpRegion"]);
                    ...
                    //League Info
                    Well_Played.Models.Summoner leagueEntry = await Facades.LeagueFacade.GetEntry((string)localSettings.Values["LookUpID"], (string)localSettings.Values["LookUpRegion"]);
