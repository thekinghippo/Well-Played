...
namespace Well_Played
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class SummonerLookUp_obj8_Bindings :
            global::Windows.UI.Xaml.IDataTemplateExtension,
            global::Windows.UI.Xaml.Markup.IComponentConnector,
            ISummonerLookUp_Bindings
        {
            ...
            public SummonerLookUp_obj8_Bindings()
            {
            }
        ...
        private class SummonerLookUp_obj1_Bindings :
            global::Windows.UI.Xaml.Markup.IComponentConnector,
            ISummonerLookUp_Bindings
        {
            private global::Well_Played.SummonerLookUp dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public SummonerLookUp_obj1_Bindings()
            {
            }
            ...
            // SummonerLookUp_obj1_Bindings

            public void SetDataRoot(global::Well_Played.SummonerLookUp newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Well_Played.SummonerLookUp obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            case 54:
                {
                    ...
                    #line 78 "..\..\..\SummonerLookUp.xaml"
                    ((global::Windows.UI.Xaml.Controls.AppBarButton)element54).Click += this.AppBarButton_Click;
                    #line default
                }
                break;
            default:
        ...
        public global::Windows.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            case 1:
                {
                    global::Windows.UI.Xaml.Controls.Page element1 = (global::Windows.UI.Xaml.Controls.Page)target;
                    SummonerLookUp_obj1_Bindings bindings = new SummonerLookUp_obj1_Bindings();
            ...
            case 8:
                {
                    ...
                    SummonerLookUp_obj8_Bindings bindings = new SummonerLookUp_obj8_Bindings();
                    returnValue = bindings;
